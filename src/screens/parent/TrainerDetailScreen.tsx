...
const styles = StyleSheet.create({
  ...
  heroOverlay: { padding: spacing[4], backgroundColor: colors.overlayDark },
  content: { padding: spacing[4], backgroundColor: colors.black, marginTop: -spacing[4] },
  header: { marginBottom: spacing[4] },
  rating: { flexDirection: 'row', alignItems: 'center', marginTop: spacing[2] },
  priceCard: { flexDirection: 'row', alignItems: 'baseline', gap: spacing[2], backgroundColor: colors.blackCard, padding: spacing[4], borderRadius: 0, borderWidth: 2, borderColor: colors.gray700, marginBottom: spacing[4] },
  section: { marginBottom: spacing[4] },
  sectionTitle: { marginBottom: spacing[3] },
  specialties: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing[2] },
  reviewCard: { backgroundColor: colors.blackCard, padding: spacing[3], borderRadius: 0, borderWidth: 2, borderColor: colors.gray700, marginBottom: spacing[2] },
  reviewHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: spacing[2] },
  trustSection: { flexDirection: 'row', justifyContent: 'space-around', paddingTop: spacing[4], borderTopWidth: 2, borderTopColor: colors.gray700 },
  trustBadge: { alignItems: 'center' },
  bottomBar: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: colors.blackCard, borderTopWidth: 2, borderTopColor: colors.gray700 },
