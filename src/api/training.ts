...
const mockTrainers: TrainerUser[] = [
  {
    ...
    galleryUrls: [heroImages[16 % heroImages.length], heroImages[17 % heroImages.length]],
  ...
  },
  {
    ...
    isVerified: true,
    isBackgroundChecked: true,
    headshotUrl: heroImages[20 % heroImages.length],
  ...
  },
  {
    ...
    isVerified: true,
    isBackgroundChecked: true,
    headshotUrl: heroImages[22 % heroImages.length],
